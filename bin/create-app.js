...
if (process.argv.length < 3) {
	...
	console.log("    npx create-fdn-app my-app", "\x1b[0m");
	process.exit(1);
...
const repo = "https://github.com/pace11/create-fdn-app.git";
...
function buildPackageJson(packageJson, folderName) {
	...
	Object.assign(newPackage, {
		"name": folderName,
		"version": "1.0.0",
		"description": "fdn frontend boilerplate",
		"author": "pace11",
		"license": "MIT",
		"bin": {
			"react-fdn-app": "./bin/create-app.js",
		},
		"scripts": {
